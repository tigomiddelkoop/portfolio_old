...
export default class PersonalInfo extends React.Component<{}, {}> {
    ...
    render(): JSX.Element {
        ...
        return (
            <Fragment>
                <div className="m:flex mb-12">
                    <img className="shadow border-2 h-64 w-64 mx-auto m:mx-0 m:mr-6 rounded-full"
                         alt="Tigo" src={Tigo}/>
                    <div className="text-center m:text-left">
                        <h1 className="text-4xl m:text-5xl font-semibold">Tigo Middelkoop</h1>
