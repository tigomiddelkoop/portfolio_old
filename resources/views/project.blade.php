            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @lang('projects.demo'): <a href="{{ $project->demo_url }}">{{ $project->demo_url }}</a><br />
                        @lang('projects.stage'):
                        @switch($project->development_stage)
                            @case(1)
                            @lang('projects.development_started')
                            @break
                            @case(2)
                            @lang('projects.development_paused')

                            @break
                            @case(3)
                            @lang('projects.development_over')
                            @break
                        @endswitch
