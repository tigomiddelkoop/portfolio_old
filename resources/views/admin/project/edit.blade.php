            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <textarea type="textarea" name="shortDescription"
                                  class="form-control">{{ $project->short_description }}</textarea>
                        <br/>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <textarea id="description" name="description"
                                  placeholder="Enter text ...">{{ $project->description }}</textarea>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <textarea id="story" name="story"
                                  placeholder="Enter text ...">{{ $project->story_behind }}</textarea>
